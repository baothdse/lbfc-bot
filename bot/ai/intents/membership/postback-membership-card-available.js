...
class PostbackMembershipCardAvailableIntent extends Intent {
    constructor(step, exception) {
        super(step, exception);
        this.addPatterns(['membership card available'], 1, true, true);
    }
...
module.exports = PostbackMembershipCardAvailableIntent