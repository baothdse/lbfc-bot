...
class PostbackMembershipCardUnavailableIntent extends Intent {
    constructor(step, exception) {
        super(step, exception);
        this.addPatterns(['membership card unavailable'], 1, true, true);
    }
...
module.exports = PostbackMembershipCardUnavailableIntent