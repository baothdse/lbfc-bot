...
class PostbackApplyPromotionIntent extends Intent {
    constructor(step, exception) {
        super(step, exception);
        this.addPatterns(['promotion select \\$'], 1, true);
    }
    ...
    matchPattern1(input, match, pattern) {
        var promotionCode = input.substring('promotion select \$'.length, input.length);
        return {
...
module.exports = PostbackApplyPromotionIntent